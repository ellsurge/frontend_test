...
import { ModalContainer } from "~/components/Atoms/UmarModalContainer/ModalContainer";
      ...
      <>
        {props.isModalOpen ? (
          <div className='fixed inset-0 z-[1000] box-border overflow-auto text-center'>
            ...
            />
            <ModalContainer
              className={`${props.containerClassName} flex flex-col items-center gap-[20px] px-[30px] py-[20px]`}
            >
              <Title
                style={{ color: "white" }}

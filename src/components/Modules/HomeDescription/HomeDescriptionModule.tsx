...
export const HomeDescriptionModule = () => {
  const Message = [
    ...
    { profileImg: nvir, reciever: 'Nvir', message: 'namulabs is a fantastic company', time: '08:43 PM' },
  ...
  return (
    <div className="flex flex-col h-full">
      <div className="text-white px-[18px] pt-2">
        ...
        <div className="mt-4">
          <SVGAtom iconName="proxima" className="mb-1 h-[65px]" />
            ...
            <li key={i} className="w-full flex items-center justify-center my-4 ml-5">
              ...
              <div className="w-[85%]">
                ...
                <div className="text-[#bfbfbf] text-[16px] font-[450] flex items-center gap-2 relative mt-1">
                  ...
                  <span className="w-[16px] h-[16px] flex items-center justify-center mr-[-50px] text-[12px] font-[600] bg-[#FF4D4F] rounded-full absolute right-[10%]">
                    1
                  </span>
                </div>
              </div>
